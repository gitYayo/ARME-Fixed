/*
 * Developed by Yayo || This is released under the GNU GPL License v3.0 || NOT allowed to be used for commercial products ||
 */
#include <unistd.h>
#include <time.h>
#include <sys/types.h>
...
//Do not bother changing versions!
...
struct urlparts {
	...
	{ "scheme", ":" },
	{ "userid", "@" },
	{ "password", ":" },  //Don't even try without user/owner consent cuz yayo aint takin responsibility!
	{ "host", "//" },
	{ "port", ":" },
	{ "path", "/" },
	{ "param", ";" },
